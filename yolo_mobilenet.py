...
from yolo3.model import yolo_eval, mobilenet_tiny_yolo_body
...
class YOLO(object):
    ...
    _defaults = {
        "model_path": '/home/zq610/WYZ/deeplearning/network/keras-yolo3/train_result/yolo_voc/mobilenet_3.13/ep063-loss7.663-val_loss9.385.h5',
    ...
    # _defaults = {
    #     "model_path": '/home/zq610/WYZ/deeplearning/network/keras-yolo3/train_setting/origin_tiny_yolo/yolov3_tiny.h5',
    ...
    def generate(self):
        ...
        try:
            ...
            self.yolo_model = mobilenet_tiny_yolo_body(Input(shape=(None,None,3)), num_anchors // 2, num_classes)
...
def detect_video(yolo, video_path, output_path=""):
    ...
    video_FourCC    = int(vid.get(6))
    video_fps       = vid.get(5)
    video_size      = (int(vid.get(3)),
                        int(vid.get(4)))
