...
def _main():
    ...
    log_dir = 'train_result/yolo_voc/yolo_origin_new_anchor_large_epoch_3.19/'
    ...
    checkpoint_stage2 = ModelCheckpoint(log_dir + 'ep{epoch:03d}-loss{loss:.3f}-val_loss{val_loss:.3f}.h5',
    ...
    if True:
        ...
        model.fit_generator(data_generator_wrapper(lines[:num_train], batch_size, input_shape, anchors, num_classes),
            ...
            epochs=300,
            initial_epoch=50,
            callbacks=[logging, checkpoint_stage2, reduce_lr, early_stopping])
